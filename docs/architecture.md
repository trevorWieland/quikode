...
stateDiagram-v2
  ...
  pending_ci --> awaiting_review: ci_green_threads_clean
  awaiting_review --> merge_ready: settle_window_elapsed
  merge_ready --> merged: merged
  pending_ci --> triaging_feedback: ci_failed_or_threads_found
  awaiting_review --> triaging_feedback: threads_found
  merge_ready --> triaging_feedback: threads_found
  triaging_feedback --> addressing_feedback: actionable_feedback
  triaging_feedback --> pending_ci: no_actionable_feedback
  ...
  merge_ready --> rebasing_to_main: parent_merged_or_conflict
  ...
  triaging_feedback --> failed: crash
  ...
  triaging_feedback --> blocked: block_task
  ...
  triaging_feedback --> rebasing_to_main: parent_merged_or_conflict
