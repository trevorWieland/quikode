...
_SHORT_STATE = {
    ...
    # Plan 58: per-stage audit short forms.
    "audit_local_ci": "audit_local",
    "audit_rubric": "audit_rubric",
    "audit_standards": "audit_std",
    "audit_architecture": "audit_arch",
    "audit_behavior": "audit_beh",
