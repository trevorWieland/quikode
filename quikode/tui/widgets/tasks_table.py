...
_STATE_STYLE = {
    ...
    # Plan 28 post-PR split: PENDING_CI shows as "running" (yellow),
    # AWAITING_REVIEW as "awaiting" (subtler). MERGE_READY retired with the
    # settle window — auto-merge on APPROVED is the new merge trigger.
